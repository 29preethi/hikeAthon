...
public class SetDestinationActivity extends Activity implements OnItemClickListener{
	...
	private static final String API_KEY = "AIzaSyDVffzQyVNYL5XgaEFiPqK3TDnNtLOK7ts";
	@Override
	...
	public static ArrayList autocomplete(String input) {
		        ...
		        try {
		            ...
		            Log.e(null, "In autocomplete" + jsonResults.toString());
		        ...
		        public Filter getFilter() {
		            Filter filter = new Filter() {
		                ...
		                protected FilterResults performFiltering(CharSequence constraint) {
		                	Log.e(null, "Entering Google places adapter");
